...
from backend.app.deliberation.providers import AgentProviderRunner, ProviderFailure, repair_suggestion_for_failure
...
def _failure_log(provider_id: str, phase: str, exc: ProviderFailure) -> DeliberationLogEntry:
